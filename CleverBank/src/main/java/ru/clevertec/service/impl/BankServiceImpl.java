...
import ru.clevertec.dao.BankDAO;
import ru.clevertec.dao.impl.BankDAOImpl;
...
import ru.clevertec.exception.badrequest.UniquePhoneNumberException;
import ru.clevertec.exception.internalservererror.JDBCConnectionException;
import ru.clevertec.exception.notfound.BankNotFoundException;
...
public class BankServiceImpl implements BankService {
    ...
    public BankResponse save(BankRequest request) {
        ...
        try {
            ...
            throw new UniquePhoneNumberException("Bank with bic " + request.bic() + " is already exist");
        }
