...
public class BankSQLUtil {
    ...
    public static final String INSERT_NEW_BANK = "INSERT INTO banks (title, bic) VALUES (?, ?)";
    public static final String UPDATE_BANK = "UPDATE banks SET title = ?, bic = ? WHERE id = ?";
