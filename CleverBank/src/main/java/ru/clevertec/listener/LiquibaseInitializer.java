...
public class LiquibaseInitializer implements ServletContextListener {
    ...
    /**
     *ѕереопредел€ет метод contextInitialized, чтобы выполнить обновление базы данных с помощью Liquibase.
     *@param event объект ServletContextEvent, содержащий информацию о контексте сервлета
     */
    ...
    /**
     * ¬озвращает объект Connection, представл€ющий соединение с базой данных PostgresSQL.
     *
     * @return объект Connection, представл€ющий соединение с базой данных PostgresSQL
