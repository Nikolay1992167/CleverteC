...
public class TransactionServlet extends HttpServlet {
     ...
     */
    private String changeBalance(Gson gson, ChangeBalanceRequest request) throws AccountNotFoundException {
     ...
     */
    private String findAllByPeriodOfDateAndAccountId(Gson gson, TransactionStatementRequest request) throws AccountNotFoundException {
     ...
     */
    private String findSumOfFundsByPeriodOfDateAndAccountId(Gson gson, TransactionStatementRequest request) throws AccountNotFoundException {
